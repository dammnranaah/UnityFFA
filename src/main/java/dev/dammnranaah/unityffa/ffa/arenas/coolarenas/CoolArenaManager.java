package dev.dammnranaah.ffa.arenas.coolarenas;
...
import static dev.dammnranaah.ffa.arenas.ArenaManager.lastArena;
                ...
                if (world != null) {
                    ...
                    if (config.contains("kit")) {
                        ...
                        if (Bukkit.getServer().getPluginManager().isPluginEnabled("dammnranaahkits")) {
                            assert kitName != null;
                            dammnranaahkitsAPI.getKitsAPI().giveKit(targetPlayer, kitName);
                        } else {
