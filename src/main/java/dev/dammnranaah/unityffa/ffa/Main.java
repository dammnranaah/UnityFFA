package dev.dammnranaah.ffa;
import dev.dammnranaah.ffa.bstats.Metrics;
import dev.dammnranaah.ffa.combat.CombatTagger;
import dev.dammnranaah.ffa.commands.SettingsCommand;
import dev.dammnranaah.ffa.commands.MessageCommand;
import dev.dammnranaah.ffa.commands.PingCommand;
import dev.dammnranaah.ffa.commands.RulesCommand;
import dev.dammnranaah.ffa.commands.SuicideCommand;
import dev.dammnranaah.ffa.commands.SitCommand;
import dev.dammnranaah.ffa.commands.HealCommand;
import dev.dammnranaah.ffa.commands.NickCommand;
import dev.dammnranaah.ffa.commands.BroadcastCommand;
import dev.dammnranaah.ffa.commands.StatsCommand;
import dev.dammnranaah.ffa.commands.ReplyCommand;
import dev.dammnranaah.ffa.commands.CoolArenaCommand;
import dev.dammnranaah.ffa.commands.settings.*;
import dev.dammnranaah.ffa.deathmessages.DeathMessagesManager;
import dev.dammnranaah.ffa.commands.FlyCommand;
import dev.dammnranaah.ffa.kits.KitManager;
import dev.dammnranaah.ffa.lobby.VoidListener;
import dev.dammnranaah.ffa.lobby.SpawnCommands;
import dev.dammnranaah.ffa.lobby.SpawnManager;
import dev.dammnranaah.ffa.regeneration.RegenerationImpl;
import dev.dammnranaah.ffa.regeneration.command.RegenerationCommand;
import dev.dammnranaah.ffa.settings.OldDamageTilt;
import dev.dammnranaah.ffa.spawnitems.Items;
import dev.dammnranaah.ffa.stats.Stats;
import dev.dammnranaah.ffa.expansion.Placeholders;
import dev.dammnranaah.ffa.stats.StatsManager;
import dev.dammnranaah.ffa.tasks.ClipboardCleaner;
import dev.dammnranaah.ffa.tasks.UpdateTask;
import dev.dammnranaah.ffa.utils.MiscListener;
import dev.dammnranaah.ffa.utils.gui.GuiManager;
import dev.dammnranaah.dammnranaahkits.api.dammnranaahkitsAPI;
...
public final class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Register();
        Commands();
        if (getServer().getPluginManager().isPluginEnabled("dammnranaahkits")) {
            dammnranaahkitsAPI.initialize();
            Bukkit.getConsoleSender().sendMessage(formatColors(prefix + "&7dammnranaahkits detected. &7Enabled support for &bdammnranaahkits &7plugin."));
        }
        try {
    ...
    private void PlaceholderAPI() {
        if (Bukkit.getPluginManager().getPlugin("PlaceholderAPI") != null) {
            ...
            Bukkit.getConsoleSender().sendMessage(formatColors(" "));
            Bukkit.getConsoleSender().sendMessage(formatColors("&7Made with &c❤️ &7 by the Dammnranaah"));
            Bukkit.getConsoleSender().sendMessage(formatColors(" "));
    ...
    private void Register() {
        ...
        // BStats
        // The plugin is named "xFFA" because the name "FFA" is already taken on BStats. "x" stands for Dammnranaah, which is our organization's name.
